...
export default function AdminNav() {
  ...
  const activeLink = "flex gap-2 p-1 bg-white text-black rounded-l-md  mr-0";
  ...
  return (
    <aside className="bg-blue-700 h-svh w-full md:w-auto top-20 rounded-l-xl transition-all p-4 pr-0  static text-white ">
      <nav className="flex flex-col gap-6">
        <Link href="/" className="flex gap-3 items-center">
          ...
          <span className="text-2xl mr-2">Juman store</span>
        </Link>
        <Link
